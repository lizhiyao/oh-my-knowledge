 ...
 *
 * @param {number[]} arr - Sample observations
 * @returns {{ mean: number, lower: number, upper: number, stddev: number }}
 */
 ...
 *
 * @param {number[]} a - Sample A observations
 * @param {number[]} b - Sample B observations
 * @returns {{ tStatistic: number, df: number, significant: boolean }}
 */
