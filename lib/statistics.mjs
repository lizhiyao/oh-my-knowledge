...
export function confidenceInterval(arr, confidence = 0.95) {
  ...
  const t = ss.tTestTwoSample(arr, arr) != null
    ? ss.probit((1 + confidence) / 2) // approximate with normal for simplicity
    : 1.96;

  // Use t-distribution critical value approximation
  // For small samples, use a lookup; for large, use 1.96
