 ...
 */
function buildSkillScript(skillDir, _transcriptPath) {
...
async function scriptExecutor({ model: _model, system, skillPath, prompt }) {
  const skillDir = skillPath || system; // skillPath is the explicit field; system is legacy fallback
  if (!skillDir) {
    return {
      ok: false, error: 'script executor requires skillPath (skill directory path)',
