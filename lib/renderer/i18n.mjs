export const I18N = {
  zh: {
    ...
    runId: '运行 ID', variants: '变体', model: '模型', samples: '样本数',
    ...
    totalTokens: '总计', tokPerReq: 'tok/次', avgLatency: '平均延迟',
    successRate: '成功率', success: '成功', errors: '失败',
    tokenComparison: 'Token 对比', latencyComparison: '延迟对比',
    autoAnalysis: '自动分析',
    perSampleDetail: '逐样本详情', sample: '样本',
    scoreCol: '分数', tokensCol: 'Tokens', msCol: '延迟(ms)',
    feedback: '反馈', feedbackPlaceholder: '备注',
    feedbackSubmit: '提交', feedbackSubmitted: '已提交',
    feedbackSelectRating: '请先选择评分', feedbackFail: '提交失败',
    switchLang: 'EN',
  },
  en: {
    title: 'OMK Bench',
    ...
    runId: 'Run ID', variants: 'Variants', model: 'Model', samples: 'Samples',
    ...
    totalTokens: 'Total', tokPerReq: 'tok/req', avgLatency: 'avg latency',
    successRate: 'success rate', success: 'Success', errors: 'Errors',
    tokenComparison: 'Token Comparison', latencyComparison: 'Latency Comparison',
    autoAnalysis: 'Auto Analysis',
    perSampleDetail: 'Per-Sample Detail', sample: 'Sample',
    scoreCol: 'Score', tokensCol: 'Tokens', msCol: 'ms',
    feedback: 'Feedback', feedbackPlaceholder: 'Comment',
    feedbackSubmit: 'Submit', feedbackSubmitted: 'Submitted',
    feedbackSelectRating: 'Please select a rating first', feedbackFail: 'Submit failed',
    switchLang: '中文',
  },
};
