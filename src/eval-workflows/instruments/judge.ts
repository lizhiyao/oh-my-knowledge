...
import type { JudgeConfig } from './contracts/config.js';
...
import { buildJudgePrompt, JUDGE_SYSTEM_PROMPT } from './prompts/judge-prompts.js';
import { buildJudgeTraceSummary } from './judge-trace.js';
// 评分类 prompt 由 instruments 领域单一持有，并受 prompt registry 冻结保护。
export { buildJudgePrompt, getJudgePromptHash } from './prompts/judge-prompts.js';
