...
export type CliEvaluationInputErrorCode =
  ...
  | 'CLI_INPUT_LEGACY_CACHE_ENABLE_UNSUPPORTED'
  | 'CLI_INPUT_CACHE_SOURCE_REQUIRED'
  | 'CLI_INPUT_CACHE_SOURCE_UNUSED'
  | 'CLI_INPUT_CACHE_SERIES_CONFLICT'
  | 'CLI_INPUT_RESUME_CACHE_CONFLICT'
