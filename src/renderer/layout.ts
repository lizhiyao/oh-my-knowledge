...
export const I18N: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    runId: '报告名称', variants: '实验分组', model: '被测模型', samples: '样本数',
    ...
    agreementHeader: '跨样本评委一致性', agreementDesc: '在所有样本上算的多评委一致性',
    ...
    judgeRepeatLabel: '每条样本评委评价次数',
    judgePromptHashLabel: '评委提示词指纹', judgePromptHashDesc: '评委提示词模板的 SHA256 前 12 位。两份报告 hash 相同才能严格比分数',
    sampleHashCount: '样本指纹', sampleHashCountDesc: '已记录内容指纹的样本数 / 全部样本数。每条样本算 SHA256 前 12 位，用于跨 run 识别"测的是不是同一件事"。两份报告对同一 sample_id hash 一致才能严格比分',
  ...
  en: {
    ...
    runId: 'Report', variants: 'Variant', model: 'Subject model', samples: 'Samples',
