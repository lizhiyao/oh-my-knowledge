...
import { RunList, SourceError } from '../../components/measure/measure';
...
export default async function MeasurePage({ searchParams }: { searchParams: Promise<{lang?: string}> }) {
  ...
  let runs;
  try { runs = await catalog.list(); } catch { return <StudioShell lang={lang}><SourceError lang={lang}/></StudioShell>; }
