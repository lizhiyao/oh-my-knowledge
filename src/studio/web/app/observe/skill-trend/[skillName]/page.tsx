...
export async function generateMetadata({ params, searchParams }: { params: Promise<{skillName: string}>; searchParams: Promise<{lang?: string}> }): Promise<Metadata> {
  const { skillName } = await params;
  return pageTitle('healthTrend', studioLang(await searchParams), skillName);
}
