...
export async function generateMetadata({ params }: { params: Promise<{analysisId: string}> }): Promise<Metadata> {
  const { analysisId } = await params;
  return pageTitle('health', await requestStudioLang(), analysisId);
}
