...
export default async function RootLayout({ children }: { children: ReactNode }) {
  ...
  return <html lang={lang}><body><AntdRegistry><StudioLanguageProvider value={lang === 'en' ? 'en' : 'zh'}><StudioNavigationProvider value={navigation}><StudioTheme>{children}</StudioTheme></StudioNavigationProvider></StudioLanguageProvider></AntdRegistry></body></html>;
}
