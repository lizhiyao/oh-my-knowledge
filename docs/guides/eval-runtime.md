...
```mermaid
flowchart TD
    CASES["You: supply questions and expected answers"] --> RUN["OMK: have both versions answer the questions"]
    CALL["You: supply a function that calls the service"] --> RUN
    RUN --> SCORE["OMK: compare actual and expected answers"]
    SCORE --> RESULT["OMK: return individual evidence, statistics and a report"]
```
...
Expand [“Exact match and model integration code”](#exact-match-evaluation) below for the complete model integration pattern. It uses your own model client. Set [concurrency, timeouts, and budgets](#production-policy) for your service before deployment. In an independent project, install `npm install oh-my-knowledge@next zod` and use examples matching the installed version; run unreleased capabilities from source first.
...
## Expand other capabilities when needed

You have now followed one complete evaluation. The sections below configure optional capabilities of the same interface; you do not need to read all of them to use it. Configuration fragments use `input` and `variants` from “Exact match and model integration code”; your application supplies clients and storage.
...
<details>
<summary>Names used in the code</summary>
...
<details>
<summary>Exact match and model integration code</summary>
...
<details>
<summary>Check retrieval relevance and ranking</summary>
...
<details>
<summary>Mixed retrieval and empty-result evaluation</summary>
...
<details>
<summary>Check whether an Agent called the required tools</summary>
...
<details>
<summary>Ask an LLM to score answers against explicit criteria</summary>
...
<details>
<summary>Inspect a plan before running</summary>
...
<details>
<summary>Check whether two runs are comparable</summary>
...
<details>
<summary>Reuse outputs after changing labels or analysis</summary>
...
<details>
<summary>Assign samples to separate version groups</summary>

The `paired` design runs both versions on every sample. Use `independent` when each sample should run on just one version, and declare allocation weights. This example stratifies by `locale`; samples must provide `executionContext.locale` and meet the group and stratum minimums. The two teaching samples in the [integration example](#exact-match-evaluation) are insufficient for these settings:
...
<details>
<summary>Apply multiple release criteria together</summary>
...
<details>
<summary>Combine metrics into one score</summary>
...
<details>
<summary>Store larger or sensitive outputs in your own storage</summary>
...
<details>
<summary>Use caches to reduce repeated calls</summary>
...
<details>
<summary>Receive progress and cancel a run</summary>
...
<details>
<summary>Set concurrency, timeouts, retries, and budgets</summary>
...
<details>
<summary>Check whether your integration meets OMK requirements</summary>
...
<details>
<summary>Give Agents isolated file workspaces</summary>
...
<details>
<summary>Per-sample tool access</summary>
...
<details>
<summary>Per-sample native MCP configuration</summary>
...
<details>
<summary>Replace selected tool calls with mock results</summary>
...
<details>
<summary>Keep a session for a multi-step Agent</summary>
...
<a id="runtime-integration-flow"></a>

<details>
<summary>Runtime integration flow</summary>
