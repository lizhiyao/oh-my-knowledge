        ...
        sidebar: [
          {
            ...
            items: [
              ...
              { text: 'Runtime scoring methods', link: '/guides/eval-runtime-scoring' },
              { text: 'Runtime experiments and reuse', link: '/guides/eval-runtime-experiments' },
              { text: 'Runtime execution and storage', link: '/guides/eval-runtime-infrastructure' },
              { text: 'Runtime Agent integration', link: '/guides/eval-runtime-agents' },
        ...
        sidebar: [
          {
            ...
            items: [
              ...
              { text: 'Runtime 评分方法', link: '/zh/guides/eval-runtime-scoring' },
              { text: 'Runtime 实验与证据复用', link: '/zh/guides/eval-runtime-experiments' },
              { text: 'Runtime 运行与存储', link: '/zh/guides/eval-runtime-infrastructure' },
              { text: 'Runtime Agent 接入', link: '/zh/guides/eval-runtime-agents' },
