...
完整的可运行 package fixture 位于 [`test/eval-runtime/fixtures/embedded-host.mjs`](https://github.com/lizhiyao/oh-my-knowledge/blob/main/test/eval-runtime/fixtures/embedded-host.mjs)。
