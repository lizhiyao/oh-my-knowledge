...
>
> **姊妹文档**：[术语规范 (terminology-spec.md)](../terminology-spec.md)（维护者内部决策归档）/ [统计严谨性](./statistical-rigor.md) / [综合分构造效度](./scoring.md)
...
- **omk 内部命名按 [terminology-spec.md](../terminology-spec.md)**：artifact / executor / variant / verdict 等。
- **特殊翻译规则**：
...
姊妹文档：[术语规范](../terminology-spec.md) / [统计严谨性](./statistical-rigor.md) / [综合分构造效度](./scoring.md) / [Roadmap](./roadmap.md)
