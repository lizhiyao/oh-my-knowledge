...
const FROZEN_LLM_ENHANCED_REVIEW_PROMPT_HASH = '79183ee7be732f613ece8d86b206e4c402e7a10b56782101e7d659c835d3deb3';

describe('LLM enhanced review prompt hash byte-level freeze', () => {
  it('v2026-05-19.v3 hash matches the frozen value', () => {
