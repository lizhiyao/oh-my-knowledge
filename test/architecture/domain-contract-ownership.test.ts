...
const PURE_DOMAIN_TYPE_FILES = [
  ...
  'src/eval-workflows/inputs/contracts/mock.ts',
  'src/eval-workflows/inputs/contracts/sample.ts',
  'src/eval-workflows/inputs/contracts/variant.ts',
  'src/eval-workflows/grading/contracts/index.ts',
  'src/eval-workflows/grading/contracts/config.ts',
  'src/eval-workflows/grading/contracts/result.ts',
