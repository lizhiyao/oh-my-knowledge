...
手把手教程：[5 分钟快速上手](docs/zh/quickstart-skill-eval.md)（推荐第一次跑评测的用户）。可直接跑的示例（A/B、离线执行器、batch、evolve、RAG、gold 等）见 [`examples/`](examples/)。
...
- **[示例集](examples/)** —— 一组可直接跑的示例，按由简到全排成上手路径
